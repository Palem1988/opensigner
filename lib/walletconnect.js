...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_164__) {
...
var _crypto = _interopRequireDefault(__webpack_require__(164));
...
function _generateKey() {
  _generateKey = _asyncToGenerator(
  /*#__PURE__*/
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            n = _args.length > 0 && _args[0] !== undefined ? _args[0] : 256 / 8;
            b = _crypto.default.randomBytes(n);
            result = b;
...
var _frisbee = _interopRequireDefault(__webpack_require__(397));
...
/*#__PURE__*/
function () {
  function Connector(url, key) {
    _classCallCheck(this, Connector);

    // set bridge url and key
    this.bridgeURL = url;
    this.sharedKey = key; // counter

    this._counter = 0; // frisbee instance

    this.frisbeeInstance = new _frisbee.default({
      baseURI: url,
      headers: {
  ...
  _createClass(Connector, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 9:
                iv = Buffer.from(rawIv); // update counter
                ...
                encryptor = _crypto.default.createCipheriv(AES_ALGORITHM, key, iv);
                encryptor.setEncoding('hex');
                encryptor.write(actualContent);
                encryptor.end(); // get cipher text

                encryptedData = encryptor.read(); // ensure that both the IV and the cipher-text is protected by the HMAC

                hmac = _crypto.default.createHmac(HMAC_ALGORITHM, key);
                ...
                return _context.abrupt("return", {
                  ...
                  aad: this._counter,
                  // message counter for the "additional authenticated data"
                  iv: iv.toString('hex')
                });
    ...
    value: function decrypt(_ref) {
      var data = _ref.data,
          ...
          nonce = _ref.nonce,
          iv = _ref.iv;
      var key = this.sharedKey;
      var ivBuffer = Buffer.from(iv, 'hex');
      var hmacBuffer = Buffer.from(hmac, 'hex');

      var chmac = _crypto.default.createHmac(HMAC_ALGORITHM, key);
      ...
      var decryptor = _crypto.default.createDecipheriv(AES_ALGORITHM, key, ivBuffer);
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this.frisbeeInstance.get("/session/".concat(this.sessionId));

              case 2:
                res = _context2.sent;
                (0, _utils.handleResponse)(res); // check for no content
              ...
              case 6:
                return _context2.abrupt("return", this.decrypt(res.body).data);
      ...
      return function _getEncryptedData(_x2) {
...
var base64 = __webpack_require__(394)
var ieee754 = __webpack_require__(395)
...
module.exports = !__webpack_require__(37) && !__webpack_require__(56)(function () {
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(275));
...
Object.defineProperty(exports, "generateKey", {
  enumerable: true,
  get: function get() {
    return _utils.generateKey;
  }
});
Object.defineProperty(exports, "WalletConnector", {
  enumerable: true,
  get: function get() {
    return _walletConnector.default;
  }
});
Object.defineProperty(exports, "WebConnector", {
  enumerable: true,
  get: function get() {
    return _webConnector.default;
  }
});

var _utils = __webpack_require__(80);

var _walletConnector = _interopRequireDefault(__webpack_require__(393));

var _webConnector = _interopRequireDefault(__webpack_require__(459));
...
var _connector = _interopRequireDefault(__webpack_require__(165));
...
function (_Connector) {
  function WalletConnector() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(WalletConnector).apply(this, arguments));
  }
  ...
  _createClass(WalletConnector, [{
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                fcmToken = sessionData.fcmToken, walletWebhook = sessionData.walletWebhook, _sessionData$data = sessionData.data, data = _sessionData$data === void 0 ? {} : _sessionData$data;
              ...
              case 8:
                ...
                _context.next = 11;
                return this.frisbeeInstance.post("/session/".concat(sessionId, "/status/new"), {
                  body: {
                    fcmToken: fcmToken,
      ...
      return function sendSessionStatus(_x) {
    ...
    value: function () {
      var _sendTransactionStatus = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2(sessionId, transactionId) {
        var statusData,
            encryptedData,
            res,
            _args2 = arguments;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                statusData = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : {};
              ...
              case 5:
                ...
                _context2.next = 8;
                return this.frisbeeInstance.post("/session/".concat(sessionId, "/transaction/").concat(transactionId, "/status/new"), {
                  body: encryptedData
                });
      ...
      return function sendTransactionStatus(_x2, _x3) {
        return _sendTransactionStatus.apply(this, arguments);
      };
    }() //
    ...
    key: "getSessionRequest",
    value: function () {
      var _getSessionRequest = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3(sessionId) {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                return _context3.abrupt("return", this._getEncryptedData("/session/".concat(this.sessionId)));
      ...
      return function getSessionRequest(_x4) {
        return _getSessionRequest.apply(this, arguments);
      };
    }() //
    ...
    value: function () {
      var _getTransactionRequest = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee4(sessionId, transactionId) {
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                return _context4.abrupt("return", this._getEncryptedData("/session/".concat(this.sessionId, "/transaction/").concat(transactionId)));
      ...
      return function getTransactionRequest(_x5, _x6) {
        return _getTransactionRequest.apply(this, arguments);
      };
    }()
  }]);
...
var _regenerator = __webpack_require__(398);

var _regenerator2 = _interopRequireDefault(_regenerator);

var _asyncToGenerator2 = __webpack_require__(400);
...
var _keys = __webpack_require__(422);

var _keys2 = _interopRequireDefault(_keys);

var _typeof2 = __webpack_require__(426);
...
var _createClass2 = __webpack_require__(444);
...
var _caseless = __webpack_require__(447);

var _caseless2 = _interopRequireDefault(_caseless);

var _qs = __webpack_require__(448);

var _qs2 = _interopRequireDefault(_qs);

var _buffer = __webpack_require__(166);

var _fetchPonyfill2 = __webpack_require__(451);

var _fetchPonyfill3 = _interopRequireDefault(_fetchPonyfill2);

var _urlJoin = __webpack_require__(452);

var _urlJoin2 = _interopRequireDefault(_urlJoin);

var _interceptor = __webpack_require__(453);
...
var stringify = __webpack_require__(449);
var parse = __webpack_require__(450);
...
function (_Connector) {
  function WebConnector() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(WebConnector).apply(this, arguments));
  }
  ...
  _createClass(WebConnector, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                _context.next = 6;
                return this.frisbeeInstance.post('/session/new');

              case 6:
                res = _context.sent;
                (0, _utils.handleResponse)(res); // session id

                this.sessionId = res.body.sessionId; // sessionId and shared key
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 5:
                encryptedData = _context2.sent;
                _context2.next = 8;
                return this.frisbeeInstance.post("/session/".concat(this.sessionId, "/transaction/new"), {
                  body: encryptedData
                });

              case 8:
                res = _context2.sent;
                (0, _utils.handleResponse)(res); // return transactionId

                return _context2.abrupt("return", res.body.transactionId);
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                return _context3.abrupt("return", this._getEncryptedData("/session/".concat(this.sessionId, "/status")));
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee4(transactionId) {
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
              ...
              case 2:
                return _context4.abrupt("return", this._getEncryptedData("/session/".concat(this.sessionId, "/transaction/").concat(transactionId, "/status")));
      ...
      return function getTransactionStatus(_x) {
