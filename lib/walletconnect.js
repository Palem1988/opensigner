...
var _frisbee = __webpack_require__(394);

var _frisbee2 = _interopRequireDefault(_frisbee);

var _buffer = __webpack_require__(189);
...
var Connector = function () {
  function Connector(url, sessionId, key) {
    ...
    // frisbee instance
    this.frisbeeInstance = new _frisbee2.default({
      baseURI: url,
      headers: {
  ...
  _createClass(Connector, [{
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this.frisbeeInstance.get('/session/' + this.sessionId);
      ...
      function _getEncryptedData(_x3) {
...
exports.WebConnector = exports.WalletConnector = exports.generateKey = undefined;

var _utils = __webpack_require__(80);

var _walletConnector = __webpack_require__(393);

var _walletConnector2 = _interopRequireDefault(_walletConnector);

var _webConnector = __webpack_require__(459);

var _webConnector2 = _interopRequireDefault(_webConnector);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.generateKey = _utils.generateKey;
exports.WalletConnector = _walletConnector2.default;
exports.WebConnector = _webConnector2.default;
...
var _connector = __webpack_require__(165);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                _context.next = 8;
                return this.frisbeeInstance.put('/session/' + this.sessionId, {
                  body: {
                    fcmToken: fcmToken,
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                _context2.next = 7;
                return this.frisbeeInstance.post('/session/' + this.sessionId + '/transaction/' + transactionId + '/status/new', {
                  body: encryptedData
                });
...
var _asyncToGenerator2 = __webpack_require__(397);

var _asyncToGenerator3 = _interopRequireDefault(_asyncToGenerator2);

var _stringify = __webpack_require__(417);
...
var _extends2 = __webpack_require__(436);
...
var _caseless = __webpack_require__(444);

var _caseless2 = _interopRequireDefault(_caseless);

var _qs = __webpack_require__(445);
...
var toAbsoluteIndex = __webpack_require__(403);
module.exports = function (IS_INCLUDES) {
  return function ($this, el, fromIndex) {
    var O = toIObject($this);
    var length = toLength(O.length);
...
var parse = __webpack_require__(447);
...
var WebConnector = function (_Connector) {
  ...
  function WebConnector() {
    ...
    return _possibleConstructorReturn(this, (WebConnector.__proto__ || Object.getPrototypeOf(WebConnector)).apply(this, arguments));
  }
  ...
  _createClass(WebConnector, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                encryptedData = _context2.sent;
                _context2.next = 7;
                return this.frisbeeInstance.post('/session/' + this.sessionId + '/transaction/new', { body: encryptedData });
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                return _context3.abrupt('return', this._getEncryptedData('/session/' + this.sessionId));
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                return _context4.abrupt('return', this._getEncryptedData('/session/' + this.sessionId + '/transaction/' + transactionId + '/status'));
      ...
      function getTransactionStatus(_x2) {
