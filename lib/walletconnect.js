        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this.frisbeeInstance.get(url);
              ...
              case 6:
                return _context2.abrupt('return', this.decrypt(res.body.data).data);
...
var WebConnector = function (_Connector) {
  ...
  _createClass(WebConnector, [{
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                encryptedData = _context3.sent;
                _context3.next = 7;
                return this.frisbeeInstance.post('/session/' + this.sessionId + '/transaction/new', {
                  body: {
                    data: encryptedData,
    ...
    key: 'listenForSessionStatus',
    value: function listenForSessionStatus(cb) {
      var _this4 = this;
